            ...
            <div class="dialog">
                <table>
                    <tbody>
                        ...
                        <tr class="prop">
                            <td valign="top" class="name"><g:message code="form.linkedInstrument.label" default="Linked Instrument" /></td>
                            
                            <td valign="top" class="value"><g:link controller="instrument" action="show" id="${formInstance?.linkedInstrument?.id}">${formInstance?.linkedInstrument?.encodeAsHTML()}</g:link></td>
