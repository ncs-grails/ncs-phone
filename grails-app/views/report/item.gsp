<html>
    ...
    <body>
    	...
    	<div class="container_12">
    		...
    		<div id="leftSide" class="grid_12 pull_12">
			    <div id="leftAccordion" class="grid_8 alpha">
			    	<% def itemIdList = trackedItemInstanceList.collect{it?.id}.join(',') %>
				    <h3 id="itemInformation"><a href="${createLink(controller:"logCall", action:'itemInformation') }/${itemIdList}">Information</a></h3>
				    <div></div>
				...
				<div id="rightSide" class="grid4 pull_4">
				    <div id="rightAccordion" class="grid_4 omega">
					    <h3 id="lookup"><a href="${createLink(controller:"logCall", action:'lookup') }/${itemIdList}">Look Up</a></h3>
					    <div></div>
		
						<h3 id="deletedTransactions"><a href="${createLink(controller:"logCall", action:'deletedTransactions') }/${itemIdList}">Deleted Transactions</a></h3>
					    <div></div>
					</div>
				</div> <!-- End rightSide -->
			</div>
